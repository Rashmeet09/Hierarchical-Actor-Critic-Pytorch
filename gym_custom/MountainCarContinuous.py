...
class Continuous_MountainCarEnv(gym.Env):
    ...
    def render_subgoals(self, subgoal, goal, mode="human"):
        ...
        self.cartrans_subgoal.set_translation(
            (pos_subgoal - self.min_position) * scale, self._height(pos_subgoal) * scale
        )
        ...
        self.cartrans_goal.set_translation(
            (pos_goal - self.min_position) * scale, self._height(pos_goal) * scale
        )
        self.cartrans_goal.set_rotation(math.cos(3 * pos_goal))
